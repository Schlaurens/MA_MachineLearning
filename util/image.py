...
def show_cell_on_image(directory, label, object_name=None, grid_dims=(15,20)):
    """Shows the given image with an illustrated cell grid of given dimension.
    ...
    if(object_name in label):
        ...
        # Get the index with the highest value. TODO: correct when there are objects that cover more than 
        # one cell.
        ...
        # Draw a rectangle on the cell that cover the object. TODO: will need modification when there
        # are multiple cell that cover an object. 
        rect = patches.Rectangle(scaled_index, cell_dims[0], cell_dims[1], linewidth=1, edgecolor='black', facecolor=(255/255, 0/255, 0/255, 140/255))
